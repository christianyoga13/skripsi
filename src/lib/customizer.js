...
export const MODEL_SLOTS = {
  ...
  sofa2: {
    ...
    secondarySlot: {
      ...
      options: FABRIC_OPTIONS,
      defaultId: "ivory",
      matTarget: { matNames: ["fabric", "pillow black", "pillow brown"] },
      textureSet: "fabric",
    },
  },
  table: {
  ...
  bed1: {
    ...
    secondarySlot: {
      ...
      options: FABRIC_OPTIONS,
      defaultId: "natural",
      matTarget: { matNames: ["Fabric03", "Fabric03.001"] },
      textureSet: "fabric",
    },
  },
  desk: {
  ...
  dining1: {
    primarySlot: {
      ...
      options: [...FRAME_OPTIONS.filter(o => o.type === "wood"), ...MARBLE_OPTIONS],
      defaultId: "wood-honey",
      matTarget: { matNames: ["Material_table"] },
      textureSet: "wood",
    },
    secondarySlot: null,
  },
  dining2: {
    primarySlot: {
      ...
      options: [...FRAME_OPTIONS.filter(o => o.type === "wood"), ...MARBLE_OPTIONS],
      defaultId: "wood-natural",
      matTarget: { matNames: ["milietblematerial.001"] },
      textureSet: "wood",
    },
    secondarySlot: {
      label: "Warna Taplak",
